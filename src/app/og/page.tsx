...
export default function OGImagePage() {
    return (
        ...
        >
            ...
            {/* main card */}
            <div
                className="relative z-10 flex flex-col items-center justify-center p-12 rounded-[2.5rem] border border-white/10 shadow-2xl overflow-hidden"
                style={{
                    background:
            ...
            >
                ...
                {/* content */}
                <div className="relative z-20 flex flex-col items-center text-center gap-6 w-full">
                    {/* avatar & domain */}
                    <div className="flex flex-col items-center gap-3 mb-2">
                        <div className="relative w-20 h-20 rounded-2xl overflow-hidden shadow-[0_0_30px_rgba(99,102,241,0.4)] border border-white/20">
                            <Image
                        ...
                        <div className="flex flex-col items-center">
                            <span className="text-white/50 text-xs font-mono tracking-widest uppercase mb-1">
                                Portfolio
                            </span>
                    ...
                    <div className="flex flex-col items-center">
                        <h1
                            className="font-extrabold tracking-tight pb-1"
                            style={{
                                fontSize: "72px",
                                lineHeight: "1.1",
                        ...
                        <h2 className="text-2xl font-semibold mt-2 tracking-wide text-indigo-200/90 flex items-center justify-center gap-3">
                            Software Engineer
                    ...
                    <div className="flex items-center justify-center gap-6 mt-6">
                        <div className="flex flex-col items-center">
                            ...
                            <span className="text-xs font-medium text-indigo-300/80 uppercase tracking-widest mt-1">Years Exp</span>
                        </div>
                        <div className="w-px h-10 bg-indigo-500/20" />
                        <div className="flex flex-col items-center">
                            <span className="text-3xl font-extrabold text-white">20+</span>
                            <span className="text-xs font-medium text-indigo-300/80 uppercase tracking-widest mt-1">Projects</span>
                        </div>
                        <div className="w-px h-10 bg-indigo-500/20" />
                        <div className="flex flex-col justify-center">
                            <div className="flex items-center gap-2 bg-indigo-500/10 border border-indigo-500/20 px-4 py-2 rounded-full">
                                ...
                                <span className="text-xs font-semibold text-indigo-100 tracking-wide">Open to Opportunities</span>
                            </div>
                        </div>
                    </div>
                </div>
